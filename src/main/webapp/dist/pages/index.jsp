  ...
  <main class="app-main">
          ...
          <div class="col-md-6">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="card-title">환영합니다, <%-- ${user.name} --%><strong>임주한(포켓몬마스터)</strong>님!</h5>
              </div>
              <div class="card-body">
                ...
                <ul class="list-group">
                  <c:forEach var="notice" items="${recentNotices}" begin="0" end="4">
                    <li class="list-group-item">
                      <a href="notice_detail.jsp?id=${notice.id}">${fn:escapeXml(notice.title)}</a>
                      <span class="float-end text-muted"><fmt:formatDate value="${notice.createdDate}" pattern="yyyy-MM-dd"/></span>
                    </li>
                  </c:forEach>
                </ul>
              </div>
    ...
    <!--end::App Content-->
      ...
      <footer class="app-footer">
        ...
        <!--begin::Copyright-->
        <strong>
          Copyright &copy;2025-05-01&nbsp;
          <a href="#" class="text-decoration-none">LDB대학교</a>.
        </strong>
        All rights reserved.
        <!--end::Copyright-->
      </footer>
