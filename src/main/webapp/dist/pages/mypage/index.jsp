	...
	<div class="app-wrapper">
		...
		<nav class="app-header navbar navbar-expand bg-body">
			...
			<div class="container-fluid">
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item d-none d-md-block"><a href="${path}/"
						class="nav-link">Home</a></li>
					<li class="nav-item d-none d-md-block"><a href="${path}/contact"
					...
					<li class="nav-item dropdown"><a class="nav-link"
						...
						<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
							<a href="#" class="dropdown-item"> <!--begin::Message-->
								<div class="d-flex">
									<div class="flex-shrink-0">
										<img src="${path}/dist/assets/img/user1-128x128.jpg"
							...
							<a href="#" class="dropdown-item"> <!--begin::Message-->
								<div class="d-flex">
									<div class="flex-shrink-0">
										<img src="${path}/dist/assets/img/user8-128x128.jpg"
											alt="User Avatar" class="img-size-50 rounded-circle me-3" />
									</div>
									<div class="flex-grow-1">
										<h3 class="dropdown-item-title">
							...
							<a href="#" class="dropdown-item"> <!--begin::Message-->
								<div class="d-flex">
									<div class="flex-shrink-0">
										<img src="${path}/dist/assets/img/user3-128x128.jpg"
											alt="User Avatar" class="img-size-50 rounded-circle me-3" />
									</div>
									<div class="flex-grow-1">
										<h3 class="dropdown-item-title">
		...
		<aside class="app-sidebar bg-body-secondary shadow"
			...
			<div class="sidebar-brand">
				<!--begin::Brand Link-->
				<a href="${path}/index.jsp" class="brand-link"> <!--begin::Brand Image-->
					...
					<ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview"
						...
						<li class="nav-item menu-open"><a href="#"
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item"><a href="${path}/index2.jsp"
									class="nav-link"> <i class="nav-icon bi bi-circle"></i>
										<p>성적확인</p>
								</a></li>
								<li class="nav-item"><a href="${path}/index3.jsp"
									class="nav-link"> <i class="nav-icon bi bi-circle"></i>
										<p>시간표조회</p>
								</a></li>
							</ul></li>
						<li class="nav-item"><a href="#" class="nav-link"> <i
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item"><a href="${path}/widgets/info-box.html"
									class="nav-link"> <i class="nav-icon bi bi-circle"></i>
										<p>수강신청 현황</p>
								</a></li>
								<li class="nav-item"><a href="${path}/widgets/cards.html"
									class="nav-link"> <i class="nav-icon bi bi-circle"></i>
										<p>미정</p>
								</a></li>
							</ul></li>
						<li class="nav-item"><a href="#" class="nav-link"> <i
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a
									href="${path}/layout/unfixed-sidebar.html" class="nav-link"> <i
										class="nav-icon bi bi-circle"></i>
										<p>강의등록</p>
								</a></li>
								<li class="nav-item"><a href="${path}/layout/fixed-sidebar.html"
									class="nav-link"> <i class="nav-icon bi bi-circle"></i>
										<p>강의관리</p>
								</a></li>
								<li class="nav-item"><a
									href="${path}/layout/layout-custom-area.html" class="nav-link"> <i
										class="nav-icon bi bi-circle"></i>
										<p>성적관리</p>
								</a></li>
								<li class="nav-item"><a href="${path}/layout/sidebar-mini.html"
									class="nav-link"> <i class="nav-icon bi bi-circle"></i>
										<p>출석관리</p>
								</a></li>
							</ul></li>
						<li class="nav-item"><a href="${path}/notice_board.jsp"
							class="nav-link"> <i class="nav-icon bi bi-tree-fill"></i>
								<p>공지사항</p>
						</a></li>
						<li class="nav-item"><a href="${path}/question_board.jsp"
							...
							<div class="card card-info card-outline">
								...
								<div class="card-body">
									<div class="d-flex flex-wrap">
										<a href="${path}/course_registration.jsp" class="btn btn-primary m-1">수강신청</a>
										<a href="${path}/grades.jsp" class="btn btn-success m-1">성적확인</a> 
										<a href="${path}/timetable.jsp" class="btn btn-warning m-1">시간표조회</a> 
										<a href="${path}/notice_board.jsp" class="btn btn-info m-1">공지사항</a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card card-warning card-outline">
								<div class="card-header">
									...
									<div class="card-tools">
										<a href="${path}/notice_board.jsp" class="btn btn-tool">전체보기</a>
									</div>
								</div>
								<div class="card-body">
									<ul class="list-group">
										<c:forEach var="notice" items="${recentNotices}" begin="0" end="4">
											<li class="list-group-item"><a
												href="${path}/notice_detail.jsp?id=${notice.id}">${fn:escapeXml(notice.title)}</a>
		...
		<footer class="app-footer">
			<!--begin::Copyright-->
			<strong> Copyright ©2025-05-01 <a href="${path}/"
